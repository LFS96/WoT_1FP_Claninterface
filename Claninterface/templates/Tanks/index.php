...
?>
    ...
    <?php if($user?->canResult("Commander",$auth)->getStatus()){ echo$this->Html->link('<i class="bi bi-cloud-download"></i> Import anstoßen',["action"=>"import"],["class" =>"btn btn-dark btn-sm","escape"=>false])."<br />";}?>
<br />
